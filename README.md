...
A **one-page**, **two asymmetric column** resume template in **XeTeX** that caters particularly to an **professional Telcom && Sw** engineer.
...
### OpenFonts
![alt tag](https://raw.githubusercontent.com/pablorlrl/Pablo-Resume/master/OpenFonts/sample-image.png)
...
3. **ShareLatex**.com (v1 fonts changes) - [compilable online](https://www.sharelatex.com/templates/cv-or-resume/pablo-resume)

## License
    Copyright 2024 Pablo Ramos
